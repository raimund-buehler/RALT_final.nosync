...
def transform_data(file_path, output_directory):
    ...
    try:
        ...
        transformed_df = df[['stim', 'ParticipantAnswer', 'Reward', 'BlockType', 'participant', 'trials.thisN', 'RunNumber']].copy()
...
# Example usage:
directory_path = 'RALT_csv_raw'  # Directory containing your raw data CSVs
output_directory = 'RL_data'  # Directory where you want to save the transformed data
